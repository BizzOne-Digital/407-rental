  ...
  return (
    <section className="relative overflow-hidden bg-brand-black">
      ...
      <div className="section-padding container-wide relative text-center">
        <h2 className="text-3xl font-bold tracking-tight text-brand-white sm:text-4xl lg:text-5xl">{displayTitle}</h2>
        <p className="mx-auto mt-4 max-w-2xl text-lg text-brand-white/80">{displaySubtitle}</p>
